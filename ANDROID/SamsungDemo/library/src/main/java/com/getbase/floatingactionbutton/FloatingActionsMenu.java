...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mMenuButtonSpacing = (int) (getResources().getDimension(R.dimen.fab_actions_spacing) - getResources().getDimension(R.dimen.fab_shadow_radius) - getResources().getDimension(R.dimen.fab_shadow_offset));
        ...
        mMenuButtonColorNormal = attr.getColor(R.styleable.FloatingActionsMenu_fab_menuButtonColorNormal, getColor(android.R.color.holo_blue_dark));
        mMenuButtonColorPressed = attr.getColor(R.styleable.FloatingActionsMenu_fab_menuButtonColorPressed, getColor(android.R.color.holo_blue_light));
        mMenuButtonSize = attr.getInt(R.styleable.FloatingActionsMenu_fab_menuButtonSize, FloatingActionButton.SIZE_NORMAL);
        mMenuButtonIcon = attr.getResourceId(R.styleable.FloatingActionsMenu_fab_menuButtonIcon, 0);
    ...
    /*
    public void setMenuButtonIcon(@DrawableRes int icon) {
        mMenuButton.setIcon(icon);
    }

    public void setMenuButtonIconDrawable(@NonNull Drawable iconDrawable) {
        mMenuButton.setIconDrawable(iconDrawable);
    }
    */
    ...
    public void addButton(FloatingActionButton button) {
        addView(button, mMenuButtonsCount - 1);
        mMenuButtonsCount++;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < mMenuButtonsCount; i++) {
        ...
        switch (mExpandDirection) {
            case EXPAND_UP:
            case EXPAND_DOWN:
                height += mMenuButtonSpacing * (getChildCount() - 1);
                height = adjustForOvershoot(height);
                break;
            case EXPAND_LEFT:
            case EXPAND_RIGHT:
                width += mMenuButtonSpacing * (getChildCount() - 1);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                int nextY = expandUp ?
                        addButtonY - mMenuButtonSpacing :
                        addButtonY + mMenuButton.getMeasuredHeight() + mMenuButtonSpacing;

                for (int i = mMenuButtonsCount - 1; i >= 0; i--) {
                    ...
                    if (label != null) {
                        ...
                        Rect touchArea = new Rect(
                                ...
                                childY - mMenuButtonSpacing / 2,
                                Math.max(childX + child.getMeasuredWidth(), labelRight),
                                childY + child.getMeasuredHeight() + mMenuButtonSpacing / 2);
                    ...
                    nextY = expandUp ?
                            childY - mMenuButtonSpacing :
                            childY + child.getMeasuredHeight() + mMenuButtonSpacing;
                }
                break;
            ...
            case EXPAND_RIGHT:
                ...
                int nextX = expandLeft ?
                        addButtonX - mMenuButtonSpacing :
                        addButtonX + mMenuButton.getMeasuredWidth() + mMenuButtonSpacing;
                ...
                for (int i = mMenuButtonsCount - 1; i >= 0; i--) {
                    ...
                    nextX = expandLeft ?
                            childX - mMenuButtonSpacing :
                            childX + child.getMeasuredWidth() + mMenuButtonSpacing;
                }
    ...
    protected void onFinishInflate() {
        ...
        mMenuButtonsCount = getChildCount();
